...
- **CI green**: run 34576581343 on HEAD `d1a2257` (offline suite: 192 unittests
  — 180 + 12 service — + 88 checks + inspect + pip check; the app/service
  sections added 40 of those checks).
